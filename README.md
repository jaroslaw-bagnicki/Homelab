...
| 2026‑06‑28 | Codespaces SP | ⭐ | [14](docs/runbooks/14-gh-codespaces-sp-for-homelab.md) | Codespaces SP in KV + repo secrets; enables Azure MCP — see [ADR 16](docs/decisions/16-gh-codespaces-sp-for-homelab.md) |
