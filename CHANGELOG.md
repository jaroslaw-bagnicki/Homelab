...
- **(docs)** Wincor Beetle M-III drive examination (research 32) — all three drives SMART-checked: SanDisk SD9SB8W128G 128 GB SSD PASSED (41,802 POH); Seagate `sdb` (`WDES3KB7`) clean (0 reallocated); **Seagate `sdc` (`WDEPBVR3`) shows 1,056 reallocated sectors** (was 0 on 2026-09-05) — verdict pending a long self-test / ATA error log before the mdadm RAID1 array is built; `hardware.md` storage row flagged — [research 32](docs/research/32-wincor-beetle-m3-hardware-diagnostic.md) · [#98](https://github.com/jaroslaw-bagnicki/Homelab/issues/98)
- **(docs)** Wincor Beetle M-III Phase 0 re-audit — rewrite `research 32` for the delivered unit: **the offered Skylake/H110/DDR4 platform is confirmed** (Pentium G4400, AES-NI present, QuickSync H.264+HEVC decode, 8 GB DDR4 → 32 GB, Intel I219-V GbE, SanDisk SD9SB8W128G 128 GB SSD SMART-PASSED, PCIe 3.0 x16 + 2× x1, no mSATA); `hardware.md` + `overview.md` + idea 01c reconciled to it, and ADR 29's platform context updated; PSU / BIOS / HDD SMART / Memtest still pending — [research 32](docs/research/32-wincor-beetle-m3-hardware-diagnostic.md) · [#98](https://github.com/jaroslaw-bagnicki/Homelab/issues/98)
