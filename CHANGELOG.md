...
- **(feat)** UPS graceful shutdown via **NUT** — LXC 213 server + fleet clients as a role (`ha` primary, `lab`/`edge` secondaries) — [ADR 30](docs/decisions/30-ups-nut-graceful-shutdown.md) · [runbook 30](docs/runbooks/30-deploy-nut-clients.md)
