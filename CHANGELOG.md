...
- **(docs)** Wyse 5070 hardware diagnostic — pre-boot audit of the Home Assistant node (research 29): J4105 confirmed, 2× 4 GB Micron DDR4 (both slots full — 16 GB = replace both), M.2 SATA slot empty (new SSD to buy), Realtek GbE + Intel WiFi, no NVMe; hardware.md/overview updated — [research 29](docs/research/29-wyse5070-hardware-diagnostic.md) · [issue #68](https://github.com/jaroslaw-bagnicki/Homelab/issues/68)
