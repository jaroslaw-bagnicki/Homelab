...
- **(docs)** Agent workflow — **never open a PR unless the user explicitly asks**; `.github/copilot-instructions.md` (default-workflow bullet) and `AGENTS.md` (new Git Workflow bullet + the *Worktree Workflow* steps) now prescribe push-and-report instead of push-and-open-a-PR
