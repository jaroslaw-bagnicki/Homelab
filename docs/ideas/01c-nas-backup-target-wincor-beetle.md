...
**Status**: 📋 Planned — **OMV**, not Unraid: [ADR 29](../decisions/29-nas-backup-target-beetle-m3-omv.md) settles the OS (Unraid deferred); the offered platform is **confirmed** by [research 32](../research/32-wincor-beetle-m3-hardware-diagnostic.md) (Skylake / H110 / DDR4, G4400, 8 GB)  
**Date**: 2026-08-22  
**Sources**:
