...
| 06 | [Homelab Energy Monitoring via Zigbee](06-homelab-energy-monitoring.md) | 🧠 Idea | Independent homelab power-consumption monitoring — Zigbee energy plugs + USB coordinator, Zigbee2MQTT → Prometheus → Grafana, AI-agent access via MQTT + Prometheus API. Details: [research 27](../research/27-zigbee-energy-monitoring.md) |
