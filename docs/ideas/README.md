...
| 01c | [Homelab NAS (Wincor Beetle M-III / Unraid)](01c-nas-backup-target-wincor-beetle.md) | 🧠 Idea | Most extensible NAS variant: Wincor Beetle M-III POS terminal (LGA1151/DDR4, 3× PCIe, industrial PSU) + 2.5" HDD array + SSD/NVMe cache on Unraid — successor candidate to idea 03 (ML110, too noisy/power-hungry) |
