...
| 06 | [Homelab Energy Monitoring via Zigbee](06-homelab-energy-monitoring.md) | 🧠 Idea | Independent homelab power-consumption monitoring — Zigbee energy plugs, decoupled from Home Assistant, data to the lab's monitoring stack + AI agent. Details: [research 27](../research/27-zigbee-energy-monitoring.md) |
