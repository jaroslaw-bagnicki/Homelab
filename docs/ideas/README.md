...
|---|---|---|---|
| 01 | [Homelab NAS](01-nas-backup-target.md) | 🧠 Idea | Fujitsu Esprimo Q956 + 2× WD Black 500 GB on OMV (V1, superseded in practice by idea 03) |
...
| 01c | [Homelab NAS (Wincor Beetle M-III)](01c-nas-backup-target-wincor-beetle.md) | 🔨 Implementing | Most extensible NAS variant: Wincor Beetle M-III POS terminal + 2.5" HDD array + SSD cache — **successor to idea 03 (ML110)**, OS settled on **OMV** (Unraid deferred) by [ADR 29](../decisions/29-nas-backup-target-beetle-m3-omv.md) |
...
| 08 | [Homelab LTE/5G WAN Failover](08-lte-wan-failover.md) | 🧠 Idea | Backup WAN for the homelab edge — reused ZTE WF830 LTE modem (Cat. 6) via Passive PoE 24V, Orange Flex additional SIM (free) as the data plan, OPNsense multi-WAN failover. Depends on [idea 07](07-opnsense-futro-s930.md); data plans: [research 30](../research/30-mobile-internet-failover-offers.md) |
| 09 | [UPS with NUT + Home Assistant](09-ups-nut-home-assistant.md) | 🔨 Implementing | Shared-rail UPS with NUT-driven graceful shutdown (NUT server on the HA node, clients across the fleet) and a Home Assistant NUT integration for telemetry, notifications, and automations. Ties into [idea 05](05-home-assistant-thin-client.md) (host) and [idea 06](06-homelab-energy-monitoring.md) (power telemetry) |
