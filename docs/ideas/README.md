...
| 05 | [Home Assistant on a Thin Client](05-home-assistant-thin-client.md) | 🧠 Idea | Dedicated Home Assistant smart-home node on a thin client (Wyse 5070 / Futro S740) — HA OS as VM on Proxmox VE, Mosquitto + Zigbee2MQTT in LXC next to it, central home placement for Zigbee coverage. Research: [research 26](../research/26-home-assistant-thin-client.md) |
