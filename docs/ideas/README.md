...
| 06 | [Homelab Energy Monitoring via Zigbee](06-homelab-energy-monitoring.md) | 🧠 Idea | Independent homelab power-consumption monitoring — Nous A1Z energy plugs + Sonoff ZBDongle-P coordinator, Zigbee2MQTT → mqtt2prometheus → Prometheus → Grafana, AI-agent access via MQTT + Prometheus API. Research: [research 27](../research/27-zigbee-energy-monitoring.md) |
