...
| **UPS + NUT graceful shutdown** | ⭐⭐ | Clients wired into the base playbooks as the `nut_client` role (`ha` primary, `lab`/`edge` secondaries); next deploy to the fleet, then the DR-style shutdown drill | [#117](https://github.com/jaroslaw-bagnicki/Homelab/issues/117) · [#111](https://github.com/jaroslaw-bagnicki/Homelab/issues/111) · [runbook 30](runbooks/30-deploy-nut-clients.md) |
