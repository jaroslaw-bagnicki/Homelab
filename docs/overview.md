...
| **UPS + NUT graceful shutdown** | ⭐⭐ | Server (LXC 213) and fleet clients deployed and verified end to end — `nut_client` role on `ha` (primary), `lab`/`edge` (secondaries), runbook 30 checklist complete; next the DR-style shutdown drill | [#117](https://github.com/jaroslaw-bagnicki/Homelab/issues/117) · [#111](https://github.com/jaroslaw-bagnicki/Homelab/issues/111) · [runbook 30](runbooks/30-deploy-nut-clients.md) |
