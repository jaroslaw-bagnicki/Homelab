...
| Item | Effort | Next step | Refs |
|---|---|---|---|
| **UPS + NUT graceful shutdown** | ⭐⭐ | Unit on the HA node (`0665:5161`, runbook 29) — execute it: LXC 103 + `nutdrv_qx` probe, then the PVE host and `lab`/`edge`/`omv` clients | [#111](https://github.com/jaroslaw-bagnicki/Homelab/issues/111) · [runbook 29](runbooks/29-nut-ups-shutdown.md) |
