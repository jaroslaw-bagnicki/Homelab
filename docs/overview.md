...
| **UPS + NUT graceful shutdown** | ⭐⭐ | Clients rolled out as the `nut_client` base role (`ha` primary, `lab`/`edge` secondaries); next the DR-style shutdown drill | [#117](https://github.com/jaroslaw-bagnicki/Homelab/issues/117) · [#111](https://github.com/jaroslaw-bagnicki/Homelab/issues/111) · [runbook 30](runbooks/30-deploy-nut-clients.md) |
