...
|---|---|---|---|
| **Netdata Parent — LAN deploy** | ⭐ | Run [runbook 31](runbooks/31-deploy-netdata.md) from a LAN workstation (`pve` → `lab` → `edge`), then flip the workload row to ✅ | [#104](https://github.com/jaroslaw-bagnicki/Homelab/issues/104) · [ADR 27](decisions/27-monitoring-strategy.md) |
