...
- **Constrained hardware** — 2 GB RAM / 8 GB eMMC are soldered (no upgrade). No Arc agent and no default-size agents; a **minimal Netdata agent** is the single exception ([ADR 27](27-monitoring-strategy.md)). If headroom is exhausted, move to the Wyse 5070. Cherry Trail is aging.
