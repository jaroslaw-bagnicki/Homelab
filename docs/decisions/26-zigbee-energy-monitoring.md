...
- **Devices**: **Nous A1Z** energy plugs (W/A/V/kWh); starter set = **4× A1Z** (USED 4-pack), expandable to one plug per key node later.
...
- Commits spend: ZBDongle-P + 4× A1Z USED 4-pack — current PL-market prices in research 27.
