...
|---|------|----------|-------|--------|
| 32 | 2026‑09‑12 | [32-wincor-beetle-m3-hardware-diagnostic.md](32-wincor-beetle-m3-hardware-diagnostic.md) | Wincor Beetle M-III pre-boot audit for the OMV NAS backup target — **Skylake/H110/DDR4** platform: Pentium G4400 (AES-NI present, QuickSync H.264+HEVC decode), 8 GiB DDR4 (1×, 1 free → 32 GB), Intel I219-V GbE, SanDisk X600 `SD9SB8W-128G` 128 GB SSD (SMART PASSED), PCIe 3.0 x16 + 2× x1; PSU/UPS + all three drives examined (`sdc` 1,056 reallocated — kept + monitored), 14–16 W idle, 43.7 dB(A); BIOS walked 2026‑09‑21 (**VT-d** enabled, `Last State` + WoL, LEGACY boot), **5 SATA ports** (3 standard + mSATA + M.2) — Memtest pending | SystemRescue 13.02 + hardinfo2 + dmidecode + smartctl + issue #98 |
