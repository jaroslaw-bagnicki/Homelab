...
|---|------|----------|-------|--------|
| 28 | 2026‑08‑17 | [28-wyse3040-hardware-diagnostic.md](28-wyse3040-hardware-diagnostic.md) | Wyse 3040 pre-boot hardware audit — full specs captured + open finding that the 8 GB eMMC is firmware-visible (ePSA Pass) but not OS-visible; BIOS handoff gap under investigation | SystemRescue 13.02 + hardinfo2 + ePSA + issue #65 |
