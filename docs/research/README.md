...
|---|------|----------|-------|--------|
| 32 | 2026‑09‑12 | [32-wincor-beetle-m3-hardware-diagnostic.md](32-wincor-beetle-m3-hardware-diagnostic.md) | Wincor Beetle M-III pre-boot audit for the OMV NAS backup target — confirmed the **offered Skylake/H110/DDR4** platform: Pentium G4400 (AES-NI present, QuickSync H.264+HEVC decode), 8 GiB DDR4 (1×, 1 free → 32 GB), Intel I219-V GbE, SanDisk SD9SB8W128G 128 GB SSD (SMART PASSED), PCIe 3.0 x16 + 2× x1, no mSATA; 2× Seagate 1 TB + PSU/BIOS pending | SystemRescue 13.02 + hardinfo2 + dmidecode + smartctl + issue #98 |
