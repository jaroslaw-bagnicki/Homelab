...
- [ADR 01 — Hardware Selection (M910q)](../decisions/01-hardware-selection-m910q.md)
- [ADR 02 — Backup Strategy (restic + Blob)](../decisions/02-backup-strategy-restic-blob.md)
- [ADR 03 — Container Strategy (Docker Compose)](../decisions/03-container-strategy.md)
- [ADR 04 — Hybrid Cloud (Arc)](../decisions/04-hybrid-cloud-azure-arc.md)
...
- [ADR 14 — Codespaces Adoption](../decisions/14-codespaces-adoption.md)
- [ADR 15 — Copilot Desktop Evaluation (Deferred)](../decisions/15-copilot-desktop-agentic.md)
- [ADR 16 — Codespaces SP](../decisions/16-gh-codespaces-sp-for-homelab.md)
