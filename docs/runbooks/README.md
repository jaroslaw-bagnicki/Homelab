...
| 20 | [20-deploy-zot.md](20-deploy-zot.md) | Self-hosted Zot OCI registry on cloudlab — htpasswd auth from AKV, pull-through cache for GHCR/mcr/Docker Hub, public at `zot.cloud5.ovh` via Cloudflare Tunnel + Caddy — see [issue #50](https://github.com/jaroslaw-bagnicki/Homelab/issues/50) |
