...
| Guests | VM 100 HA OS `192.168.2.210` · LXC 101 Mosquitto `192.168.2.211` · LXC 102 Zigbee2MQTT `192.168.2.212` · LXC 103 NUT `192.168.2.213` — `.210 + (VMID - 100)`, [ADR 31](decisions/31-static-address-scheme.md) |
