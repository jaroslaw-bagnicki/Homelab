...
| `playbooks/playbook-pve.yml` | Wyse 5070 Proxmox host base provision: common → security → nut_client → netdata (UFW LAN allow for SSH + Proxmox UI 8006 + Netdata 19999) |
